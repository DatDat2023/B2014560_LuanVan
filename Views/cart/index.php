                ...
                <div class="col-lg-12">
                    <div class="shoping__cart__table">
                        <table>
                            <thead>
                                <tr>
                                    <th class="shoping__product" style="color:#610B38; font-family:times">TÊN SÁCH </th>
                                    <th  style="color:#610B38;font-family:times" >Giá</th>
                                    <th  style="color:#610B38;font-family:times" >Số lượng</th>
                                    <th  style="color:#610B38;font-family:times">Tổng cộng</th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr style="<?php echo ($outOfProduct==true)?'background: #e1e1e1;':''; ?>">
                                    <td class="shoping__cart__item">
                                        ...
                                        <h5 style="font-family:times; font-size:24px; font-style: italic;"><?php echo $value['Name']; ?><?php echo ($outOfProduct==true)?' (Sản phẩn này tạm thời hết hàng)':''; ?></h5>
                                    </td>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="shoping__cart__btns">
                        <a href="#" class="primary-btn cart-btn" style="background-color:#FA5858;color:white;">Tiếp tục mua sắm</a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="shoping__continue">
                        <div class="shoping__discount">
                            <h5 style="font-family:times">Mã Giảm Giá</h5>
                            <i style="color:red;"><?php echo $message??""; ?></i>
                            <br/><a href="" onclick="delete_cookie('voucherCode');delete_cookie('voucherCodePercent');location.reload();" class="link-primary" id="cancelVoucher"><i style="font-family:times;font-size:20px">Hủy mã giảm giá</i></a>
                            <style>
                                #cancelVoucher:hover{
                                    color:#000;
                                }
                            ...
                            <form action="" method="post">
                                ...
                                <button type="submit" class="site-btn" style="background-color:#0A0A2A">Áp dụng</button>
                            </form>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="shoping__checkout">
                        <h5 style="font-family:times">TỔNG SỐ GIỎ HÀNG</h5>
                        <ul>
                            <?php
                            ...
                            ?>
                            <li style="font-family:times">Tổng tiền <span id="MoneySubTotal"><?php echo $priteSubTotal;?>VNĐ</span></li>
                            <li style="font-family:times">Tổng phải thanh toán <span id="MoneyTotal"><?php echo $priteTotal;?>VNĐ</span></li>
                        </ul>
                        <a href="./thanhtoan" <?php echo $outOfProductAll?'onclick="alert(`Bạn có 1 sản phẩm hết hàng, vui lòng xóa khỏi giỏ hàng. Và tải lại trang`);return false;"':""; ?> class="primary-btn" style="background-color:#0A0A2A">Thanh Toán</a>
                    </div>
                </div>
            </div>
        </div>
