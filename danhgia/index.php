...
<div class="container">		
	<h2>TDBOOK CÓ LÀM BẠN HÀI LÒNG KHÔNG?</h2>
	<?php
	...
	<div id="ratingDetails"> 		
		<div class="row">			
			...
			<div class="col-sm-3">
				<button type="button" id="rateProduct" class="btn btn-default">Đánh giá và nhận xét</button>
			</div>		
		</div>
		<div class="row">
			<div class="col-sm-7">
				...
				?>				
					<div class="row">
						<div class="col-sm-3">
							<img src="image/abt.jpg" class="img-rounded" style="width:50px;"
		...
		<div class="row">
			<div class="col-sm-12">
				<form id="ratingForm" method="POST">					
					...
					<div class="form-group">
						<button style="background:red" type="submit" class="btn btn-info" id="saveReview">Save Review</button> <button type="button" class="btn btn-info" id="cancelReview">Cancel</button>
					</div>			
				</form>
			</div>
		</div>
	...
	<div style="margin:50px 0px 0px 0px;">
		<a class="btn btn-default read-more" style="background:#0B243B;color:white" href="index.php">BACK</a>	
